    ...
    const fetchParticipatedClubs = async () => {
      try {
        ...
        const sampleClubs: Club[] = [
          ...
          { id: '2', name: 'Photography', image: 'https://via.placeholder.com/40' },
          { id: '3', name: 'Competitions', image: 'https://via.placeholder.com/40' },
          { id: '4', name: 'Trekking', image: 'https://via.placeholder.com/40' },
          { id: '5', name: 'Events', image: 'https://via.placeholder.com/40' },
          { id: '6', name: 'Painting', image: 'https://via.placeholder.com/40' },
        ];
  ...
  return (
    <div className="h-screen w-full flex flex-col">
      <div className='flex border h-[7vh]'>
          <h1 className='text-3xl font-bold mt-4 ml-8'>CLUBS</h1>
      </div>
